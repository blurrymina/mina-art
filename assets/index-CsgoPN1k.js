 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Jp;function SE(){if(Jp)return gs;Jp=1;var r=sd(),e=Symbol.for("react.element"),t=Symbol.for("react.fragment"),s=Object.prototype.hasOwnProperty,o=r.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,l={key:!0,ref:!0,__self:!0,__source:!0};function c(f,h,g){var _,y={},v=null,N=null;g!==void 0&&(v=""+g),h.key!==void 0&&(v=""+h.key),h.ref!==void 0&&(N=h.ref);for(_ in h)s.call(h,_)&&!l.hasOwnProperty(_)&&(y[_]=h[_]);if(f&&f.defaultProps)for(_ in h=f.defaultProps,h)y[_]===void 0&&(y[_]=h[_]);return{$$typeof:e,type:f,key:v,ref:N,props:y,_owner:o.current}}return gs.Fragment=t,gs.jsx=c,gs.jsxs=c,gs}var Xp;function CE(){return Xp||(Xp=1,cc.exports=SE()),cc.exports}var j=CE(),F=sd();const IE=wE(F),TE=vE({__proto__:null,default:IE},[F]);var _a={},fc={exports:{}},wt={},hc={exports:{}},pc={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Zp;function kE(){return Zp||(Zp=1,function(r){function e($,G){var z=$.length;$.push(G);e:for(;0<z;){var C=z-1>>>1,O=$[C];if(0<o(O,G))$[C]=G,$[z]=O,z=C;else break e}}function t($){return $.length===0?null:$[0]}function s($){if($.length===0)return null;var G=$[0],z=$.pop();if(z!==G){$[0]=z;e:for(var C=0,O=$.length,ie=O>>>1;C<ie;){var le=2*(C+1)-1,pe=$[le],ge=le+1,ke=$[ge];if(0>o(pe,z))ge<O&&0>o(ke,pe)?($[C]=ke,$[ge]=z,C=ge):($[C]=pe,$[le]=z,C=le);else if(ge<O&&0>o(ke,z))$[C]=ke,$[ge]=z,C=ge;else break e}}return G}function o($,G){var z=$.sortIndex-G.sortIndex;return z!==0?z:$.id-G.id}if(typeof performance=="object"&&typeof performance.now=="function"){var l=performance;r.unstable_now=function(){return l.now()}}else{var c=Date,f=c.now();r.unstable_now=function(){return c.now()-f}}var h=[],g=[],_=1,y=null,v=3,N=!1,R=!1,P=!1,T=typeof setTimeout=="function"?setTimeout:null,U=typeof clearTimeout=="function"?clearTimeout:null,B=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function V($){for(var G=t(g);G!==null;){if(G.callback===null)s(g);else if(G.startTime<=$)s(g),G.sortIndex=G.expirationTime,e(h,G);else break;G=t(g)}}function Q($){if(P=!1,V($),!R)if(t(h)!==null)R=!0,Be(fe);else{var G=t(g);G!==null&&Ie(Q,G.startTime-$)}}function fe($,G){R=!1,P&&(P=!1,U(ne),ne=-1),N=!0;var z=v;try{for(V(G),y=t(h);y!==null&&(!(y.expirationTime>G)||$&&!ye());){var C=y.callback;if(typeof C=="function"){y.callback=null,v=y.priorityLevel;var O=C(y.expirationTime<=G);G=r.unstable_now(),typeof O=="function"?y.callback=O:y===t(h)&&s(h),V(G)}else s(h);y=t(h)}if(y!==null)var ie=!0;else{var le=t(g);le!==null&&Ie(Q,le.startTime-G),ie=!1}return ie}finally{y=null,v=z,N=!1}}var he=!1,se=null,ne=-1,ve=5,Se=-1;function ye(){return!(r.unstable_now()-Se<ve)}function Me(){if(se!==null){var $=r.unstable_now();Se=$;var G=!0;try{G=se(!0,$)}finally{G?st():(he=!1,se=null)}}else he=!1}var st;if(typeof B=="function")st=function(){B(Me)};else if(typeof MessageChannel<"u"){var Fe=new MessageChannel,Ve=Fe.port2;Fe.port1.onmessage=Me,st=function(){Ve.postMessage(null)}}else st=function(){T(Me,0)};function Be($){se=$,he||(he=!0,st())}function Ie($,G){ne=T(function(){$(r.unstable_now())},G)}r.unstable_IdlePriority=5,r.unstable_ImmediatePriority=1,r.unstable_LowPriority=4,r.unstable_NormalPriority=3,r.unstable_Profiling=null,r.unstable_UserBlockingPriority=2,r.unstable_cancelCallback=function($){$.callback=null},r.unstable_continueExecution=function(){R||N||(R=!0,Be(fe))},r.unstable_forceFrameRate=function($){0>$||125<$?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):ve=0<$?Math.floor(1e3/$):5},r.unstable_getCurrentPriorityLevel=function(){return v},r.unstable_getFirstCallbackNode=function(){return t(h)},r.unstable_next=function($){switch(v){case 1:case 2:case 3:var G=3;break;default:G=v}var z=v;v=G;try{return $()}finally{v=z}},r.unstable_pauseExecution=function(){},r.unstable_requestPaint=function(){},r.unstable_runWithPriority=function($,G){switch($){case 1:case 2:case 3:case 4:case 5:break;default:$=3}var z=v;v=$;try{return G()}finally{v=z}},r.unstable_scheduleCallback=function($,G,z){var C=r.unstable_now();switch(typeof z=="object"&&z!==null?(z=z.delay,z=typeof z=="number"&&0<z?C+z:C):z=C,$){case 1:var O=-1;break;case 2:O=250;break;case 5:O=1073741823;break;case 4:O=1e4;break;default:O=5e3}return O=z+O,$={id:_++,callback:G,priorityLevel:$,startTime:z,expirationTime:O,sortIndex:-1},z>C?($.sortIndex=z,e(g,$),t(h)===null&&$===t(g)&&(P?(U(ne),ne=-1):P=!0,Ie(Q,z-C))):($.sortIndex=O,e(h,$),R||N||(R=!0,Be(fe))),$},r.unstable_shouldYield=ye,r.unstable_wrapCallback=function($){var G=v;return function(){var z=v;v=G;try{return $.apply(this,arguments)}finally{v=z}}}}(pc)),pc}var eg;function RE(){return eg||(eg=1,hc.exports=kE()),hc.exports}/**
 * @license React
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const wk=Math.log(2);class Ek{constructor(e){const t=l=>parseInt(Math.log(l)/wk,10),s=l=>parseInt(Array(l+1).join("1"),2);this.count=t(e+1),this.current_=this.count-1;const o=s(this.count);this.bits_=e+1&o}nextBitIsOne(){const e=!(this.bits_&1<<this.current_);return this.current_--,e}}const ja=function(r,e,t,s){r.sort(e);const o=function(h,g){const _=g-h;let y,v;if(_===0)return null;if(_===1)return y=r[h],v=t?t(y):y,new et(v,y.node,et.BLACK,null,null);{const N=parseInt(_/2,10)+h,R=o(h,N),P=o(N+1,g);return y=r[N],v=t?t(y):y,new et(v,y.node,et.BLACK,R,P)}},l=function(h){let g=null,_=null,y=r.length;const v=function(R,P){const T=y-R,U=y;y-=R;const B=o(T+1,U),V=r[T],Q=t?t(V):V;N(new et(Q,V.node,P,null,B))},N=function(R){g?(g.left=R,g=R):(_=R,g=R)};for(let R=0;R<h.count;++R){const P=h.nextBitIsOne(),T=Math.pow(2,h.count-(R+1));P?v(T,et.BLACK):(v(T,et.BLACK),v(T,et.RED))}return _},c=new Ek(r.length),f=l(c);return new Et(s||e,f)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ht{constructor(e,t){this.bucket=e,this.path_=t}get path(){return this.path_}get isRoot(){return this.path.length===0}fullServerUrl(){const e=encodeURIComponent;return"/b/"+e(this.bucket)+"/o/"+e(this.path)}bucketOnlyServerUrl(){return"/b/"+encodeURIComponent(this.bucket)+"/o"}static makeFromBucketSpec(e,t){let s;try{s=Ht.makeFromUrl(e,t)}catch{return new Ht(e,"")}if(s.path==="")return s;throw Y1(e)}static makeFromUrl(e,t){let s=null;const o="([A-Za-z0-9.\\-_]+)";function l(Q){Q.path.charAt(Q.path.length-1)==="/"&&(Q.path_=Q.path_.slice(0,-1))}const c="(/(.*))?$",f=new RegExp("^gs://"+o+c,"i"),h={bucket:1,path:3};function g(Q){Q.path_=decodeURIComponent(Q.path)}const _="v[A-Za-z0-9_]+",y=t.replace(/[.]/g,"\\."),v="(/([^?#]*).*)?$",N=new RegExp(`^https?://${y}/${_}/b/${o}/o${v}`,"i"),R={bucket:1,path:3},P=t===Ev?"(?:storage.googleapis.com|storage.cloud.google.com)":t,T="([^?#]*)",U=new RegExp(`^https?://${P}/${o}/${T}`,"i"),V=[{regex:f,indices:h,postModify:l},{regex:N,indices:R,postModify:g},{regex:U,indices:{bucket:1,path:2},postModify:g}];for(let Q=0;Q<V.length;Q++){const fe=V[Q],he=fe.regex.exec(e);if(he){const se=he[fe.indices.bucket];let ne=he[fe.indices.path];ne||(ne=""),s=new Ht(se,ne),fe.postModify(s);break}}if(s==null)throw q1(e);return s}}class J1{constructor(e){this.promise_=Promise.reject(e)}getPromise(){return this.promise_}cancel(e=!1){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function X1(r,e,t){let s=1,o=null,l=null,c=!1,f=0;function h(){return f===2}let g=!1;function _(...T){g||(g=!0,e.apply(null,T))}function y(T){o=setTimeout(()=>{o=null,r(N,h())},T)}function v(){l&&clearTimeout(l)}function N(T,...U){if(g){v();return}if(T){v(),_.call(null,T,...U);return}if(h()||c){v(),_.call(null,T,...U);return}s<64&&(s*=2);let V;f===1?(f=2,V=0):V=(s+Math.random())*1e3,y(V)}let R=!1;function P(T){R||(R=!0,v(),!g&&(o!==null?(T||(f=2),clearTimeout(o),y(0)):T||(f=1)))}return y(0),l=setTimeout(()=>{c=!0,P(!0)},t),P}function Z1(r){r(!1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Cv="storage";function hP(r=gd(),e){r=Pt(r);const s=sl(r,Cv).getImmediate({identifier:e}),o=p_("storage");return o&&pP(s,...o),s}function pP(r,e,t,s={}){dP(r,e,t,s)}function gP(r,{instanceIdentifier:e}){const t=r.getProvider("app").getImmediate(),s=r.getProvider("auth-internal"),o=r.getProvider("app-check-internal");return new fP(t,s,o,e,Lr)}function mP(){Rr(new rr(Cv,gP,"PUBLIC").setMultipleInstances(!0)),tn(zm,Vm,""),tn(zm,Vm,"esm2017")}mP();const _P={apiKey:"AIzaSyANdwlpY4ZNrKhq6GfCXUuQaUs4y2W9Yq4",authDomain:"mina-art.firebaseapp.com",databaseURL:"https://mina-art-default-rtdb.europe-west1.firebasedatabase.app/",projectId:"mina-art",storageBucket:"mina-art.firebasestorage.app",messagingSenderId:"595256450426",appId:"1:595256450426:web:c1f34a0c2a52c17b8a8ac3",measurementId:"G-H8Y5S6RNRK"},Zd=C_(_P),yP=$1(Zd);hP(Zd);const vP=kR(Zd),wP=async(r,e)=>{try{await RN(yP,r,e)}catch{throw new Error("Authentication failed: ")}},EP=()=>{const{t:r}=Ci(),[e,t]=F.useState(1),[s,o]=F.useState([]),[l,c]=F.useState(null),[f,h]=F.useState(!0),g=ld(),_=1,y=4;F.useEffect(()=>{l?document.body.style.overflow="hidden":document.body.style.overflow=""},[l]);const v=async()=>{try{const P=_R(vP,"images"),T=await yR(P);if(T.exists()){const U=T.val(),B=Object.keys(U).map(V=>({id:V,...U[V]}));B.sort((V,Q)=>V.order-Q.order),o(B)}}catch(P){console.error("Error fetching images:",P)}finally{h(!1)}};F.useEffect(()=>{v()},[]);const N=P=>{const T=(P-1)*_;return s.slice(T,T+_)},R=()=>{const P=Math.ceil(s.length/_),T=[];let U=1,B=P;P>y&&(e<=Math.ceil(y/2)?B=y:e+Math.floor(y/2)>=P?U=P-y+1:(U=e-Math.floor(y/2),B=e+Math.floor(y/2))),U>1&&T.push(j.jsx("button",{onClick:()=>t(1),children:r("Start")},"first"));for(let V=U;V<=B;V++)T.push(j.jsx("button",{className:V===e?"active":"",onClick:()=>t(V),children:V},V));return B<P&&T.push(j.jsx("button",{onClick:()=>t(P),children:r("End")},"last")),T};return j.jsxs("section",{id:"gallery",className:"gallery",children:[j.jsx("h1",{"data-key":"gallery-title",className:"section-fade",children:r("gallery-title")}),j.jsx("button",{"data-key":"gallery-random",id:"randomImageBtn",onClick:()=>{let P=Math.floor(Math.random()*Math.ceil(s.length/_))+1;for(;P===e;)P=Math.floor(Math.random()*Math.ceil(s.length/_))+1;t(P)},disabled:f,className:f?"disabled":"section-fade",children:r("gallery-random")}),f?j.jsx("div",{className:"loading-spinner",children:j.jsx("span",{children:"Loading images..."})}):j.jsx("div",{id:"gallery-container",children:N(e).map(P=>j.jsx("img",{src:`data:image/png;base64,${P.blob}`,alt:`Artwork ${P.id}`,className:"lazy-load",onClick:()=>c(`data:image/png;base64,${P.blob}`)},P.id))}),j.jsx("div",{id:"pagination-controls",className:"section-fade",children:R()}),j.jsx("button",{className:"section-fade",onClick:()=>g("/admin"),children:r("go-to-admin")}),l&&j.jsxs("div",{className:"popup",onClick:()=>c(null),style:{display:"flex"},children:[j.jsx("img",{src:l,alt:"Popup Artwork"}),j.jsx("span",{className:"close",onClick:()=>c(null),children:"×"})]})]})},SP=()=>{const{t:r}=Ci();return j.jsxs("section",{id:"about",className:"about",children:[j.jsx("h2",{"data-key":"about-title",className:"section-fade",children:r("about-title")}),j.jsx("p",{"data-key":"about-description",className:"section-fade",children:r("about-description")}),j.jsxs("div",{className:"social",children:[j.jsx("a",{href:"https://www.instagram.com/blurryminah/",target:"_blank","aria-label":"Instagram",className:"section-fade",children:j.jsx("i",{className:"fab fa-instagram"})}),j.jsx("a",{href:"https://www.tiktok.com/@blurryminah",target:"_blank","aria-label":"TikTok",className:"section-fade",children:j.jsx("i",{className:"fab fa-tiktok"})})]})]})},CP=()=>{const{t:r}=Ci();return j.jsx("footer",{children:j.jsxs("p",{"data-key":"footer-text",children:["© 2025 ",r("footer-text")]})})},IP=()=>{const{t:r}=Ci();return j.jsxs("section",{id:"painting-game",className:"painting-game",children:[j.jsx("h2",{"data-key":"drawing-title",className:"section-fade",children:r("drawing-title")}),j.jsx("iframe",{src:"https://jspaint.app",title:"Painting Game"})]})},Bm=()=>{const[r,e]=F.useState(""),[t,s]=F.useState(""),[o,l]=F.useState(null),c=ld(),f=async h=>{h.preventDefault();try{await wP(r,t),c("/admin")}catch{l("Failed to sign in. Please check your credentials.")}};return j.jsx("section",{id:"admin-login",className:"admin-login",children:j.jsxs("form",{onSubmit:f,children:[j.jsx("h2",{children:"Admin Login"}),o&&j.jsx("p",{children:o}),j.jsx("input",{type:"email",value:r,onChange:h=>e(h.target.value),placeholder:"Email",required:!0}),j.jsx("input",{type:"password",value:t,onChange:h=>s(h.target.value),placeholder:"Password",required:!0}),j.jsx("button",{type:"submit",children:"Login"})]})})},TP=()=>(F.useEffect(()=>{const r=window.matchMedia("(pointer: coarse)").matches,e=document.querySelectorAll("header nav ul li a"),t=document.querySelectorAll("section");function s(){let c=null,f=Number.POSITIVE_INFINITY;if(t.forEach(h=>{const g=h.getBoundingClientRect(),_=Math.abs(g.top);_<f&&(f=_,c=h)}),window.innerHeight+window.scrollY>=document.body.offsetHeight-10&&(c=t[t.length-1]),c){e.forEach(g=>g.classList.remove("active"));const h=document.querySelector(`header nav ul li a[href="#${c.id}"]`);h&&h.classList.add("active")}}function o(c){c.preventDefault();const h=c.currentTarget.getAttribute("href");if(!h||h==="#")return;const g=document.querySelector(h);if(!g)return;const _=g.getBoundingClientRect().top+window.scrollY,y=window.scrollY,v=_-y,N=1e3;let R=null;function P(U,B,V,Q){return U/=Q/2,U<1?V/2*U*U+B:(U--,-V/2*(U*(U-2)-1)+B)}function T(U){R||(R=U);const B=U-R,V=P(B,y,v,N);window.scrollTo(0,V),B<N?requestAnimationFrame(T):s()}requestAnimationFrame(T)}r||e.forEach(c=>c.addEventListener("click",o)),window.addEventListener("scroll",s),s();function l(){var g;const c=document.querySelector(".painting-game iframe"),f=((g=document.querySelector("header"))==null?void 0:g.offsetHeight)||0,h=window.innerHeight>window.innerWidth;c&&(h?(c.style.width="90vw",c.style.height=`${window.innerHeight-f-120}px`):(c.style.width="85vw",c.style.height=`${window.innerHeight-f-100}px`))}return window.addEventListener("load",l),window.addEventListener("resize",l),()=>{r||e.forEach(c=>c.removeEventListener("click",o)),window.removeEventListener("scroll",s),window.removeEventListener("load",l),window.removeEventListener("resize",l)}},[]),F.useEffect(()=>{const r=document.querySelectorAll(".section-fade"),e={root:null,rootMargin:"-50px",threshold:[0,.5,1]},t=o=>{o.forEach(l=>{const c=l.target;l.isIntersecting?(c.style.transition="opacity 1.7s ease",c.style.opacity="1"):(c.style.transition="none",c.style.opacity="0")})},s=new IntersectionObserver(t,e);return r.forEach(o=>{s.observe(o)}),()=>{r.forEach(o=>{s.unobserve(o)})}},[]),j.jsx($S,{i18n:it,children:j.jsxs(IS,{basename:"/mina-art",children:[" ",j.jsxs(ES,{children:[j.jsx(Ss,{path:"/",element:j.jsxs(j.Fragment,{children:[j.jsx(UC,{}),j.jsx(jC,{}),j.jsx(EP,{}),j.jsx(IP,{}),j.jsx(SP,{}),j.jsx(CP,{})]})}),j.jsx(Ss,{path:"/admin",element:j.jsx(Bm,{})}),j.jsx(Ss,{path:"/login",element:j.jsx(Bm,{})}),j.jsx(Ss,{path:"*",element:j.jsx(vS,{to:"/"})})]})]})}));xE.createRoot(document.getElementById("root")).render(j.jsx(F.StrictMode,{children:j.jsx(TP,{})}));
